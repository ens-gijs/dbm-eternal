...
/**
 * A simple class for verifying multithreaded unit tests.  If any thread has a failed
 ...
 *
 * @see <a href="https://github.com/threadly/threadly/blob/master/src/main/java/org/threadly/util/Clock.java">Threadly source</a>
 */
    ...
    public void waitForTest(long timeoutInMs, int signalCount) throws InterruptedException,
        ...
        synchronized (notifyLock) {
            while (this.signalCount < signalCount &&
                ...
                remainingWaitTime = timeoutInMs - (System.currentTimeMillis() - startTime);
            }
        }
